...
if env["platform"] == "macos":
    library = env.SharedLibrary(
        "bin/godotopencvextension.{}.{}.framework/godotopencvextension.{}.{}".format(
    ...
    library = env.SharedLibrary(
        "bin/godotopencvextension{}{}".format(env["suffix"], env["SHLIBSUFFIX"]),
        source=sources,
    )
...
target_path = 'bin/opencvextension.gdextension'
